...
describe('voucher.service.ts', () => {
  describe('#createVoucher()', () => {
    describe('should return success and expected', () => {
      ...
      test.each(table)('params: $params.paginations', async ({ params, expected, barcode }) => {
    ...
    describe('percent > 100, should throw HttpException The amount of reduction is too big', () => {
      ...
      test.each(table)('params: $params.paginations', async ({ params, expected }) => {
    ...
    describe('#generateRandomBarcode()', () => {
      describe('should return success and expected', () => {
        ...
        test.each(table)('params: $params.paginations', async ({ expected }) => {
          const actualReturn = await voucherServices.generateRandomBarcode()
